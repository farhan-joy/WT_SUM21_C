		...
		<fieldset>
			<table align="center">
				...
				<tr>
					...
					<td>: <input type="number" name="id" placeholder="Student enrollment id">  </td>
				...
				<tr>
					<td>Courseid</td>
					<td>: <input type="number" name="cid" placeholder="Coursetid"></td>
				...
				<tr>
					<td colspan="2" align="center"><input style="width:85px" type="submit" name="insert" value="Insert" 
					
					colspan="2" align="center"><input style="width:75px" type="submit" name="delete" value="Delete" 
					
					colspan="2" align="left"><input type="submit" name="update" value="Update" colspan="2" align="center">
					
					<input type="submit" name="clear" value="Clear" colspan="2" align="center"><input type="submit" name="showall" 
					value="Show All"
