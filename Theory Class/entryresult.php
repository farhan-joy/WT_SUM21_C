		...
		<fieldset>
			...
			<table>
				<tr>
					...
					<td><input type="number" name="id" placeholder="Result Id" value="<?php echo $rid; ?>"> </td>
					<td><span> <?php echo $err_rid;?> </span></td>
				</tr>
				<tr>
					<td align="right">Student Enrollment Id: </td>
					<td><input type="number" name="id" placeholder="Enrollment Id" value="<?php echo $sid; ?>">  </td>
				...
				<tr>
					...
					<td colspan="2" align="center"><input type="submit" name="" value="delete"></td>
				</tr>
